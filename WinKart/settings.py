"""
Django settings for WinKart project.
...
WSGI_APPLICATION = 'WinKart.wsgi.application'

AUTH_USER_MODEL = 'accounts.Account' #as we update the base_user_model we have to let settins.py file to know
